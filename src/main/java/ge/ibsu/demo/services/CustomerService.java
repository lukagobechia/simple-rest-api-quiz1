...
public class CustomerService {
    ...
    public Page<CustomerAddress> findCustomersAddress(SearchCustomer searchCustomer, Paging paging) {
        ...
        return customerRepository.searchAddressInfo(searchText, pageable);
    }
