...
public class CustomerController {
    ...
    @RequestMapping(value = "/getCustomersAddress", method = RequestMethod.POST, produces = {"application/json"})
    public Page<CustomerAddress> searchAddress(@RequestBody RequestData<SearchCustomer> requestData) throws Exception {
                    GeneralUtil.checkRequiredProperties(requestData.getData(), Arrays.asList("searchText"));

        return customerService.findCustomersAddress(requestData.getData(), requestData.getPaging());
    }
